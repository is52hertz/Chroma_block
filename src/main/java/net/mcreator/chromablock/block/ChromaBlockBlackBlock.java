...
public class ChromaBlockBlackBlock extends ChromaBlockModElements.ModElement {
	@ObjectHolder("chroma_block:chroma_block_black")
	public static final Block block = null;

	public ChromaBlockBlackBlock(ChromaBlockModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chroma_block_black");
		}
