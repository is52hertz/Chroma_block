...
public class BbChromaBlockRedBlock extends ChromaBlockModElements.ModElement {
	@ObjectHolder("chroma_block:bb_chroma_block_red")
	public static final Block block = null;

	public BbChromaBlockRedBlock(ChromaBlockModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bb_chroma_block_red");
		}
