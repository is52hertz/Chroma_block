...
public class ChromaBlockWhiteBlock extends ChromaBlockModElements.ModElement {
	@ObjectHolder("chroma_block:chroma_block_white")
	public static final Block block = null;

	public ChromaBlockWhiteBlock(ChromaBlockModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chroma_block_white");
		}
