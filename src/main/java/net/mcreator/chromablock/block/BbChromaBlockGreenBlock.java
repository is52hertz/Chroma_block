...
public class BbChromaBlockGreenBlock extends ChromaBlockModElements.ModElement {
	@ObjectHolder("chroma_block:bb_chroma_block_green")
	public static final Block block = null;

	public BbChromaBlockGreenBlock(ChromaBlockModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bb_chroma_block_green");
		}
