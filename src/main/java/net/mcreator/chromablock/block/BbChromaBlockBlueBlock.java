...
public class BbChromaBlockBlueBlock extends ChromaBlockModElements.ModElement {
	@ObjectHolder("chroma_block:bb_chroma_block_blue")
	public static final Block block = null;

	public BbChromaBlockBlueBlock(ChromaBlockModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bb_chroma_block_blue");
		}
