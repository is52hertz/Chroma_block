...
public class BbChromaBlockPinkBlock extends ChromaBlockModElements.ModElement {
	@ObjectHolder("chroma_block:bb_chroma_block_pink")
	public static final Block block = null;

	public BbChromaBlockPinkBlock(ChromaBlockModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bb_chroma_block_pink");
		}
