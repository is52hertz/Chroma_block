...
public class ChromaBlockBlueBlock extends ChromaBlockModElements.ModElement {
	@ObjectHolder("chroma_block:chroma_block_blue")
	public static final Block block = null;

	public ChromaBlockBlueBlock(ChromaBlockModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chroma_block_blue");
		}
