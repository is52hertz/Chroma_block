...
public class ChromaBlockRedBlock extends ChromaBlockModElements.ModElement {
	@ObjectHolder("chroma_block:chroma_block_red")
	public static final Block block = null;

	public ChromaBlockRedBlock(ChromaBlockModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chroma_block_red");
		}
