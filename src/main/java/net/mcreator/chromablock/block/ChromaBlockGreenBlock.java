...
public class ChromaBlockGreenBlock extends ChromaBlockModElements.ModElement {
	@ObjectHolder("chroma_block:chroma_block_green")
	public static final Block block = null;

	public ChromaBlockGreenBlock(ChromaBlockModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chroma_block_green");
		}
